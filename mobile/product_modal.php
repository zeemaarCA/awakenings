     ...
     while ($row_pro = mysqli_fetch_array($run_pro)) {
          ...
          $output .= '
                ...
                <tr>
                    ...
                    <input type="number" name="cart_quantity" value="1" class="form-control w-100 d-inline">
                    <input type="hidden" name="pro_id_modal" value="' . $pro_id . '">
                  '. $sp_session_btn.'


                    <a href="index.php?add_wishlist=' . $pro_id . '" class="modal-cart-btn t-12" name="view_pro" id=" ' . $pro_id . ' " data-toggle="tooltip" data-html="true" title="Add to wishlist">Add to wishlist</a></td>
                    </form>
                    </tr>
                ';
     }
