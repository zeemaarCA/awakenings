  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>Not registerd yet? <a href="javascript:void(0)" class="modal-link-signup"> Register here</a> </p>
      </div>
    </div>
  </div>
</div>
...
<!-- product_detail modal -->
  <div class="modal-wrapper" id="product_detail" style="display: none;">
    <div class="modal-dialog contact-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="title">Product Detail</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body" id="pro_detail">
