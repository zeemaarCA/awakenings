  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Holistic Eating Out</a></li>
      </ol>
    </nav>
  </div>
    ...
    <div class="row">
      <div class="col-lg-9 px-0">
        <div class="body-heading">
          <h1 class="browsing">Browsing : &nbsp; holistic eating out</h1>
        </div>
        <div class="row">
          <?php
          $get_article = "SELECT * FROM articles WHERE page_name = 'holistic-eating'  order by posted_at ASC";
