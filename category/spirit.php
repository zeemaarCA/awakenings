  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Spirit</a></li>
      </ol>
    </nav>
  </div>
    ...
    <div class="row">
      <div class="col-lg-9 px-0">
        <div class="body-heading">
          <h1 class="browsing">Browsing : &nbsp; spirit</h1>
        </div>
        <div class="row">
          <?php
          $get_article = "SELECT * FROM articles WHERE article_main_cat = 'spirit'  order by posted_at DESC";
