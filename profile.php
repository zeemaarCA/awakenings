            ...
            <div class="form-deliver col-lg-12">
              <form>
                ...
                <div class="text-right mr-3">
                  <a href="#" class="primary-btn" data-toggle="modal" data-target="#updateprofile"><i class="fas fa-pencil-alt"></i> update</a>
                  <a href="#" data-toggle="modal" data-target="#changePass" class="primary-btn"><i class="fa fa-cog"></i> change password</a>
                </div>
              </form>
            </div>
          </div>
